...
(`add_block`, `update_block`, `set_step_logic`, …), nunca reescrevendo o
...
| 5 | Catálogo completo de blocos + upload de mídia para MinIO/S3 | ⏳ |
| 6 | Webhooks, e-mail via Resend, pixels, analytics de abandono | ⏳ |

Cobertura de testes hoje: 39 unitários (schema, lógica, operações, camada da IA)
e 14 e2e em mobile e desktop (funil público ponta a ponta e fluxo do editor).
