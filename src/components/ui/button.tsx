...
const buttonStyles = cva(
  "inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-150 ease-app disabled:pointer-events-none disabled:opacity-50 whitespace-nowrap active:scale-[0.98]",
  {
    variants: {
      variant: {
        primary: "bg-app-primary text-white hover:bg-app-primary-hover",
        secondary: "border border-app-border bg-app-surface-2 text-app-text hover:border-app-primary/40 hover:bg-app-border",
